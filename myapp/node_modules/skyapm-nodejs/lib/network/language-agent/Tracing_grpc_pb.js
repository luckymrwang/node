...
var language$agent_Tracing_pb = require('../language-agent/Tracing_pb.js');
...
function serialize_SegmentObject(arg) {
  if (!(arg instanceof language$agent_Tracing_pb.SegmentObject)) {
    throw new Error('Expected argument of type SegmentObject');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_SegmentObject(buffer_arg) {
  return language$agent_Tracing_pb.SegmentObject.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var TraceSegmentReportServiceService = exports.TraceSegmentReportServiceService = {
  collect: {
    ...
    requestType: language$agent_Tracing_pb.SegmentObject,
    responseType: common_Common_pb.Commands,
    requestSerialize: serialize_SegmentObject,
    requestDeserialize: deserialize_SegmentObject,
