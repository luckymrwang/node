...
function serialize_BrowserErrorLog(arg) {
    if (!(arg instanceof browser_BrowserPerf_pb.BrowserErrorLog)) {
        throw new Error('Expected argument of type BrowserErrorLog');
    }
    return Buffer.from(arg.serializeBinary());
}
function deserialize_BrowserErrorLog(buffer_arg) {
    return browser_BrowserPerf_pb.BrowserErrorLog.deserializeBinary(new Uint8Array(buffer_arg));
}
function serialize_BrowserPerfData(arg) {
    if (!(arg instanceof browser_BrowserPerf_pb.BrowserPerfData)) {
        throw new Error('Expected argument of type BrowserPerfData');
    }
    return Buffer.from(arg.serializeBinary());
}
function deserialize_BrowserPerfData(buffer_arg) {
...
var BrowserPerfServiceService = exports.BrowserPerfServiceService = {
    ...
    collectPerfData: {
        path: '/BrowserPerfService/collectPerfData',
        requestStream: false,
        responseStream: false,
        requestType: browser_BrowserPerf_pb.BrowserPerfData,
        responseType: common_Common_pb.Commands,
        requestSerialize: serialize_BrowserPerfData,
        requestDeserialize: deserialize_BrowserPerfData,
    ...
    collectErrorLogs: {
        path: '/BrowserPerfService/collectErrorLogs',
        requestStream: true,
        responseStream: false,
        requestType: browser_BrowserPerf_pb.BrowserErrorLog,
        responseType: common_Common_pb.Commands,
        requestSerialize: serialize_BrowserErrorLog,
        requestDeserialize: deserialize_BrowserErrorLog,
        responseSerialize: serialize_Commands,
        responseDeserialize: deserialize_Commands,
    },
};
exports.BrowserPerfServiceClient = grpc.makeGenericClientConstructor(BrowserPerfServiceService);
//# sourceMappingURL=BrowserPerf_grpc_pb.js.map